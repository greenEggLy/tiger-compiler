...
public:
  ...
  [[nodiscard]] virtual int MaxArgs() const;
...
public:
  ...
  //        and ` IntAndTable *Interp(Table *)`
  [[nodiscard]] virtual int MaxArgs() const = 0;
  [[nodiscard]] virtual int NumExps() const = 0;
  virtual IntAndTable *Interp(Table *) const = 0;
  [[nodiscard]] virtual Exp *GetExp() const = 0;
...
public:
  ...
  // TODO: you'll have to add some definitions here (lab1).
  [[nodiscard]] int MaxArgs() const override;
  [[nodiscard]] int NumExps() const override;
  IntAndTable *Interp(Table *) const override;
  Exp *GetExp() const override { return exp; }
  ExpList *GetNext() const override { return tail; }
...
public:
  ...
  ExpList *GetNext() const override { return nullptr; }
